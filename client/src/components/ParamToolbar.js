    ...
    return (
        <ButtonGroup vertical style={{ "float": "right", "paddingRight": 30 }}>
            ...
            <FormGroup style={{marginBottom: "0px", paddingBottom: "0px", width: "100%"}}>
                <FormLabel htmlFor="loadUpload" style={{marginBottom: "0px", paddingBottom: "10px", width: "100%"}} class="btn btn-primary">
                    Load params
                    <FormControl id="loadUpload" type="file" accept=".txt" onChange={loadParams}
                        style={{display: "none", padding: "0px", margin: "0px"}} />
                </FormLabel>
                <FormLabel htmlFor="saveUpload" style={{marginBottom: "0px", paddingBottom: "10px", width: "100%"}} class="btn btn-primary">
                    Save params
                    <FormControl id="saveUpload" type="file" accept=".txt" onChange={saveParams}
                        style={{display: "none", padding: "0px", margin: "0px"}} />
                </FormLabel>
            </FormGroup>
